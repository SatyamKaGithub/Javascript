...
To be able to access this object literal, it is very common to assign it to a variable  */
var user = {}
...
//then use the dot notation to declare new properties on the fly, and use the assignment operator to add 
//values to those properties; for example
var house2 = {};
house2.rooms = 4;
house2.color = "pink";
