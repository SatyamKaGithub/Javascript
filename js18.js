...
21
car.color = "red"; //update the value of a property of the car objjectvar car = {};

These are known as properties, and can take many data types, including functions.

12345678
var car = {}; car.color = "red"; //add a method to the car object so that it can be called as car.turnkey()car.turnKey = function() {   console.log('engine running'); }
...
1234
var car = {};car.mileage = 98765;car.color = "red";console.log(car);
...
12345678
var car = {};car.mileage = 98765;car.color = "red";console.log(car);car.turnTheKey = function() {    console.log("The engine is running")}console.log(car);
...
1234567891011121314
//example of adding properties and methods to an objectvar car = {};car.mileage = 98765;car.color = "red";console.log(car);car.turnTheKey = function() {    console.log("The engine is running")}car.lightsOn = function() {    console.log("The lights are on.")}console.log(car);car.turnTheKey();car.lightsOn()
